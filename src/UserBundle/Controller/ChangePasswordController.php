...
class ChangePasswordController extends Controller
{
    ...
    public function changePasswordAction(Request $request)
    {
        ...
        $this->formFactory=$this->get('fos_user.change_password.form.factory');
        $user = $this->getUser();
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            if (null === $response = $event->getResponse()) {
                $url = $this->generateUrl('account_setting');
        ...
        return $this->render('@Front/User/dashboardsecuritysetting.html.twig', array(
